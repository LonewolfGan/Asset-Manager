...
- Name: seo.spec.ts >> no two tool pages have the same title
- Location: tests/e2e/seo.spec.ts:52:1
...
Expected value: not "EverydayTools Hub — Free Online Tools | Convert PDF, Images, Calculate"
Received array:     ["EverydayTools Hub — Free Online Tools | Convert PDF, Images, Calculate"]
```
