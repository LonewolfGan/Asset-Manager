...
const EN: Translations = {
  ...
  tools: {
    ...
    "background-remover": { title: "Background Remover", description: "Removes image backgrounds using an AI model that runs on your device. The model downloads once and processes everything locally." },
...
const FR: Translations = {
  ...
  tools: {
    ...
    "background-remover": { title: "Suppression du Fond", description: "Supprimez l'arrière-plan de vos images avec l'IA intégrée. Aucun écran vert, aucun envoi de fichiers vers un serveur." },
