        ...
        {file && previewUrl && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
              ...
              <button onClick={() => setFlipH((f) => !f)} style={{ padding: '8px 14px', border: `1px solid ${flipH ? 'var(--accent)' : 'var(--border)'}`, borderRadius: 'var(--radius-md)', background: flipH ? 'var(--accent-subtle)' : 'var(--bg-surface)', color: flipH ? 'var(--accent)' : 'var(--text-primary)', fontFamily: 'var(--font-ui)', fontSize: 'var(--text-sm)', cursor: 'pointer' }}>⇔ Flip Horizontal</button>
              <button onClick={() => setFlipV((f) => !f)} style={{ padding: '8px 14px', border: `1px solid ${flipV ? 'var(--accent)' : 'var(--border)'}`, borderRadius: 'var(--radius-md)', background: flipV ? 'var(--accent-subtle)' : 'var(--bg-surface)', color: flipV ? 'var(--accent)' : 'var(--text-primary)', fontFamily: 'var(--font-ui)', fontSize: 'var(--text-sm)', cursor: 'pointer' }}>⇕ Flip Vertical</button>
            </div>
