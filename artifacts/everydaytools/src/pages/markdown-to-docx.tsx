...
export default function MarkdownToDocx() {
  ...
  const faqs = [
    { q: "Does it support headings and bold text?", a: "Yes, headings (H1–H6) and inline formatting are converted into Word styles." },
    { q: "Are bullet points supported?", a: "Yes, Markdown lists are converted into Word bullet points." },
    { q: "Are images supported?", a: "Images are not embedded in the DOCX output — only text content is converted." },
