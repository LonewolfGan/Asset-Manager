      ...
      {imgObj && (
        <div style={{ marginTop: 24 }}>
          <div style={{ display: 'flex', gap: 8, marginBottom: 16, flexWrap: 'wrap' }}>
            <button onClick={() => setAspectRatio(null)} style={{ padding: '6px 12px', background: aspectRatio === null ? 'var(--accent)' : 'var(--bg)', color: aspectRatio === null ? 'var(--accent-text)' : 'var(--text)', border: '1px solid var(--border)', borderRadius: 'var(--radius)', cursor: 'pointer', fontSize: 'var(--text-sm)' }}>Free</button>
            <button onClick={() => setAspectRatio(1)} style={{ padding: '6px 12px', background: aspectRatio === 1 ? 'var(--accent)' : 'var(--bg)', color: aspectRatio === 1 ? 'var(--accent-text)' : 'var(--text)', border: '1px solid var(--border)', borderRadius: 'var(--radius)', cursor: 'pointer', fontSize: 'var(--text-sm)' }}>1:1 (Square)</button>
            <button onClick={() => setAspectRatio(4/3)} style={{ padding: '6px 12px', background: aspectRatio === 4/3 ? 'var(--accent)' : 'var(--bg)', color: aspectRatio === 4/3 ? 'var(--accent-text)' : 'var(--text)', border: '1px solid var(--border)', borderRadius: 'var(--radius)', cursor: 'pointer', fontSize: 'var(--text-sm)' }}>4:3</button>
            <button onClick={() => setAspectRatio(16/9)} style={{ padding: '6px 12px', background: aspectRatio === 16/9 ? 'var(--accent)' : 'var(--bg)', color: aspectRatio === 16/9 ? 'var(--accent-text)' : 'var(--text)', border: '1px solid var(--border)', borderRadius: 'var(--radius)', cursor: 'pointer', fontSize: 'var(--text-sm)' }}>16:9</button>
            <button onClick={() => setAspectRatio(3/2)} style={{ padding: '6px 12px', background: aspectRatio === 3/2 ? 'var(--accent)' : 'var(--bg)', color: aspectRatio === 3/2 ? 'var(--accent-text)' : 'var(--text)', border: '1px solid var(--border)', borderRadius: 'var(--radius)', cursor: 'pointer', fontSize: 'var(--text-sm)' }}>3:2</button>
          </div>
