...
export default function PdfSplit() {
  ...
  return (
    <>
      ...
      <p style={{ color: 'var(--text-secondary)', marginBottom: 32, fontSize: 15, fontFamily: 'var(--font-ui)' }}>{t.tools['pdf-split']?.description ?? 'Extract pages or split a PDF document into multiple files.'}</p>
