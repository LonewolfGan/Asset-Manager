  ...
  const processFile = async () => {
    ...
    try {
      if (file.type === "application/pdf") {
        ...
        a.click();
        setStatus("done");
        setResultText("PDF downloaded successfully.");
      } else {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 pb-12">
      <div className="space-y-2">
        <h1 className="font-serif text-3xl text-foreground">Document Converter</h1>
        <p className="text-muted-foreground">Convert PDFs, DOCX, and TXT files directly in your browser. All processing is local.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card className="border-border">
          <CardHeader>
            ...
            <CardDescription>Select a PDF, DOCX, or TXT file.</CardDescription>
          </CardHeader>
        ...
        <Card className="border-border flex flex-col">
          <CardHeader>
            ...
            <CardDescription>Extracted text or downloaded file.</CardDescription>
          </CardHeader>
            ...
            {status === "done" && resultText && file?.type !== "text/plain" ? (
              ...
              <div className="flex items-center justify-center h-full text-center p-8 text-muted-foreground border border-border rounded-md border-dashed">
                <div className="space-y-2">
                  ...
                  <p>PDF converted and downloaded successfully.</p>
                </div>
              </div>
            ) : (
              <div className="flex items-center justify-center h-full text-center p-8 text-muted-foreground border border-border rounded-md border-dashed">
