...
export default function TxtToPdf() {
  ...
  return (
    <>
      ...
      <h1 style={{ fontFamily: 'var(--font-display)', fontSize: 36, marginBottom: 8, color: 'var(--text-primary)' }}>{t.tools['txt-to-pdf']?.title ?? 'Text to PDF'}</h1>
      <p style={{ color: 'var(--text-secondary)', marginBottom: 32, fontSize: 'var(--text-sm)', fontFamily: 'var(--font-ui)' }}>{t.tools['txt-to-pdf']?.description ?? 'Convert plain text into a perfectly formatted PDF document.'}</p>
