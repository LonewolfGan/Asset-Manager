...
export default function TxtToPdf() {
  ...
  return (
    <>
      ...
      <p style={{ color: 'var(--text-secondary)', marginBottom: 32, fontSize: 15, fontFamily: 'var(--font-ui)' }}>{t.tools['txt-to-pdf']?.description ?? 'Convert plain text into a perfectly formatted PDF document.'}</p>
