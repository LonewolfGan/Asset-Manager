...
export const tools = [
  ...
  {slug: 'reorder-pdf', title: 'Reorder PDF Pages', description: 'Lets you drag PDF pages into a new order and remove any you do not want. Download the rearranged result when done.', category: 'pdf', icon: ArrowLeftRight, formats: ['PDF']},
  ...
  {slug: 'word-to-markdown', title: 'Word to Markdown', description: 'Converts DOCX files to Markdown. Translates headings, bold, italic, lists, and tables where the structure allows.', category: 'word', icon: FileText, formats: ['DOCX','MD']},
  {slug: 'html-to-markdown', title: 'HTML to Markdown', description: 'Converts HTML into clean Markdown text. Strips tags and turns the structure into readable Markdown syntax.', category: 'word', icon: Code2, formats: ['HTML','MD']},
  {slug: 'markdown-to-pdf', title: 'Markdown to PDF', description: 'Renders a Markdown file as a PDF document. Supports headings, lists, tables, and code blocks.', category: 'word', icon: FileDown, formats: ['MD','PDF']},
  ...
  {slug: 'excel-to-csv', title: 'Excel to CSV', description: 'Exports Excel sheets as comma-separated CSV files. One sheet becomes one CSV file.', category: 'excel', icon: Table2, formats: ['XLSX','CSV']},
  {slug: 'csv-to-excel', title: 'CSV to Excel', description: 'Converts a CSV file into an Excel .xlsx workbook. Column types are detected automatically where possible.', category: 'excel', icon: FileSpreadsheet, formats: ['CSV','XLSX']},
  {slug: 'csv-to-json', title: 'CSV ↔ JSON', description: 'Switches between CSV and JSON formats. Paste either one and get the other — headers become keys.', category: 'excel', icon: Braces, formats: ['CSV','JSON']},
  {slug: 'csv-viewer', title: 'CSV Viewer', description: 'Loads a CSV and displays it as a sortable table. Nothing gets uploaded — the file stays in your browser the whole time.', category: 'excel', icon: Table2, formats: ['CSV']},
  ...
  {slug: 'pptx-to-images', title: 'PowerPoint to Images', description: 'Exports each slide in a PowerPoint as a PNG image. Downloads as a ZIP file with all slides included.', category: 'pptx', icon: FileImage, formats: ['PPTX','PNG']},
  {slug: 'pdf-to-pptx', title: 'PDF to PowerPoint', description: 'Converts each page of a PDF into a PowerPoint slide. Each page is placed as an image on its own slide.', category: 'pptx', icon: Presentation, formats: ['PDF','PPTX']},

  // Image Tools
  {slug: 'image-converter', title: 'Image Converter', description: 'Switches between PNG, JPEG, WebP, AVIF, BMP, GIF, TIFF, ICO, and SVG. Handles batches of up to 20 files at once.', category: 'image', icon: ImageIcon, formats: ['PNG','JPG','WEBP','AVIF']},
  ...
  {slug: 'heic-to-png', title: 'HEIC to PNG', description: 'Converts HEIC photos to PNG format. PNG gives lossless quality and works in basically every image viewer.', category: 'image', icon: Smartphone, formats: ['HEIC','PNG']},
  {slug: 'heic-to-webp', title: 'HEIC to WebP', description: 'Converts HEIC photos to WebP. WebP gives smaller file sizes than JPEG with similar visual quality.', category: 'image', icon: Smartphone, formats: ['HEIC','WEBP']},
  {slug: 'heic-to-pdf', title: 'HEIC to PDF', description: 'Packages HEIC photos into a PDF document. Useful for sharing iPhone photos with people who need a PDF specifically.', category: 'image', icon: Smartphone, formats: ['HEIC','PDF']},
  ...
  {slug: 'image-to-pdf', title: 'Image to PDF', description: 'Combines one or more images into a single PDF. Add multiple images and reorder them before generating.', category: 'image', icon: ImageIcon2, formats: ['IMG','PDF']},
  ...
  {slug: 'png-to-webp', title: 'PNG to WebP', description: 'Converts PNG images to WebP. WebP is smaller than PNG for most images while still looking lossless at high quality settings.', category: 'image', icon: ArrowRightLeft, formats: ['PNG','WEBP']},
  {slug: 'jpg-to-webp', title: 'JPG to WebP', description: 'Converts JPEG images to WebP. WebP usually compresses better than JPEG at the same visual quality.', category: 'image', icon: ArrowRightLeft, formats: ['JPG','WEBP']},
  {slug: 'gif-to-webp', title: 'GIF to WebP', description: 'Converts GIF images to WebP. WebP supports animation and is typically smaller than an equivalent GIF.', category: 'image', icon: ArrowRightLeft, formats: ['GIF','WEBP']},
  {slug: 'bmp-to-webp', title: 'BMP to WebP', description: 'Converts BMP images to WebP. BMP files are large and uncompressed — WebP is much more practical for sharing.', category: 'image', icon: ArrowRightLeft, formats: ['BMP','WEBP']},
  {slug: 'tiff-to-webp', title: 'TIFF to WebP', description: 'Converts TIFF images to WebP. Good for shrinking scanned documents or images from photography workflows.', category: 'image', icon: ArrowRightLeft, formats: ['TIFF','WEBP']},
  {slug: 'webp-to-png', title: 'WebP to PNG', description: 'Converts WebP images to PNG. Useful when you need a format that older tools or browsers still recognize.', category: 'image', icon: ArrowRightLeft, formats: ['WEBP','PNG']},
  {slug: 'webp-to-jpg', title: 'WebP to JPG', description: 'Converts WebP to JPEG. JPEG opens in any photo app or browser without exception.', category: 'image', icon: ArrowRightLeft, formats: ['WEBP','JPG']},
  {slug: 'webp-to-pdf', title: 'WebP to PDF', description: 'Embeds a WebP image in a PDF document. Useful for sharing images as a fixed-layout file.', category: 'image', icon: ArrowRightLeft, formats: ['WEBP','PDF']},
  {slug: 'webp-to-avif', title: 'WebP to AVIF', description: 'Converts WebP to AVIF. AVIF can compress further than WebP with similar visual quality.', category: 'image', icon: ArrowRightLeft, formats: ['WEBP','AVIF']},
  {slug: 'jpg-to-avif', title: 'JPG to AVIF', description: 'Converts JPEG to AVIF. AVIF typically produces smaller files than JPEG at the same visual quality.', category: 'image', icon: ArrowRightLeft, formats: ['JPG','AVIF']},
  {slug: 'png-to-avif', title: 'PNG to AVIF', description: 'Converts PNG to AVIF. AVIF handles both lossy and lossless compression — worth trying on large images.', category: 'image', icon: ArrowRightLeft, formats: ['PNG','AVIF']},
  {slug: 'avif-to-jpg', title: 'AVIF to JPG', description: 'Converts AVIF images to JPEG. JPEG works in any browser or photo app, unlike AVIF.', category: 'image', icon: ArrowRightLeft, formats: ['AVIF','JPG']},
  {slug: 'avif-to-png', title: 'AVIF to PNG', description: 'Converts AVIF to PNG. PNG is lossless and opens in every modern image viewer.', category: 'image', icon: ArrowRightLeft, formats: ['AVIF','PNG']},
  {slug: 'jpg-to-png', title: 'JPG to PNG', description: 'Converts JPEG to PNG. PNG is lossless and supports transparency — JPEG handles neither.', category: 'image', icon: ArrowRightLeft, formats: ['JPG','PNG']},
  {slug: 'png-to-jpg', title: 'PNG to JPG', description: 'Converts PNG to JPEG. JPEG produces smaller files for photos, though it discards some detail in the process.', category: 'image', icon: ArrowRightLeft, formats: ['PNG','JPG']},
  {slug: 'png-to-svg', title: 'PNG to SVG', description: 'Wraps a PNG image inside an SVG container. The image stays raster — this is for embedding in SVG workflows, not for vectorizing.', category: 'image', icon: ArrowRightLeft, formats: ['PNG','SVG']},
  {slug: 'svg-to-png', title: 'SVG to PNG', description: 'Rasterizes an SVG to PNG. Set the output dimensions and the vector is drawn at that pixel resolution.', category: 'image', icon: ArrowRightLeft, formats: ['SVG','PNG']},
  {slug: 'gif-to-png', title: 'GIF to PNG', description: 'Extracts the first frame of a GIF as a PNG image. Useful when you need a still from an animated file.', category: 'image', icon: ArrowRightLeft, formats: ['GIF','PNG']},
  {slug: 'bmp-to-jpg', title: 'BMP to JPG', description: 'Converts BMP to JPEG. BMP files are uncompressed and large — JPEG handles photos at a fraction of the size.', category: 'image', icon: ArrowRightLeft, formats: ['BMP','JPG']},
  {slug: 'tiff-to-jpg', title: 'TIFF to JPG', description: 'Converts TIFF to JPEG. TIFF is common in photography and scanning, but JPEG is more practical for sharing.', category: 'image', icon: ArrowRightLeft, formats: ['TIFF','JPG']},
  {slug: 'tiff-to-png', title: 'TIFF to PNG', description: 'Converts TIFF to PNG. PNG keeps lossless quality and opens in any modern image viewer.', category: 'image', icon: ArrowRightLeft, formats: ['TIFF','PNG']},
  {slug: 'jpg-to-pdf', title: 'JPG to PDF', description: 'Packages a JPEG image into a PDF file. Common for sharing photos through systems that only accept PDFs.', category: 'image', icon: ArrowRightLeft, formats: ['JPG','PDF']},
  {slug: 'png-to-pdf', title: 'PNG to PDF', description: 'Packages a PNG image into a PDF file. Common for exporting screenshots or diagrams in a fixed-layout format.', category: 'image', icon: ArrowRightLeft, formats: ['PNG','PDF']},
  ...
  {slug: 'ai-text-scrubber', title: 'AI Text Scrubber', description: 'Removes invisible Unicode characters and patterns that some AI detection tools flag. Paste your text, clean it, and copy the result.', category: 'privacy', icon: ScanText, formats: ['TXT']},
  ...
  {slug: 'html-formatter', title: 'HTML Formatter', description: 'Formats messy HTML into readable, indented code. Also minifies it when you need to strip whitespace before shipping.', category: 'textCode', icon: Code2, formats: ['HTML']},
  ...
  {slug: 'lorem-ipsum', title: 'Lorem Ipsum Generator', description: 'Generates placeholder text for designs or prototypes. Set how many paragraphs, sentences, or words you need.', category: 'textCode', icon: FileText, formats: []},
  ...
  {slug: 'unit-converter', title: 'Unit Converter', description: 'Converts between 200+ units across 13 categories — length, weight, temperature, area, volume, speed, and more. Results update as you type.', category: 'calculators', icon: ArrowLeftRight, formats: []},
