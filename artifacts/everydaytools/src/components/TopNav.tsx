...
const GROUPS: { id: string; pairs: NavPair[] }[] = [
  {
    ...
    pairs: [
      ...
      [{ href: "/pdf-watermark" }, { href: "/pdf-compress" }],
      [null, null],
      [{ href: "/pdf-to-image" }, { href: "/pdf-to-excel" }],
      [{ href: "/reorder-pdf" }, { href: "/ocr" }],
    ],
  },
  {
    id: "documents",
    pairs: [
      [{ href: "/word-to-pdf" }, { href: "/word-to-text" }],
      [{ href: "/word-to-html" }, { href: "/word-to-epub" }],
      [{ href: "/word-to-markdown" }, { href: "/html-to-markdown" }],
      [null, null],
      [{ href: "/excel-to-pdf" }, { href: "/excel-to-csv" }],
      [{ href: "/csv-to-excel" }, { href: "/csv-to-json" }],
      [{ href: "/csv-viewer" }, null],
      [null, null],
      [{ href: "/pptx-to-pdf" }, { href: "/pptx-to-images" }],
      [{ href: "/pdf-to-pptx" }, null],
      [null, null],
      [{ href: "/markdown-to-pdf" }, { href: "/markdown-to-docx" }],
      [{ href: "/html-to-pdf" }, { href: "/txt-to-pdf" }],
      [{ href: "/txt-to-docx" }, null],
    ],
  },
  {
    id: "images",
    pairs: [
      [{ href: "/image-converter" }, { href: "/image-compress" }],
      [{ href: "/image-resize" }, { href: "/image-crop" }],
      [{ href: "/image-to-pdf" }, { href: "/background-remover" }],
      [{ href: "/flip-rotate-image" }, { href: "/watermark-image" }],
      [{ href: "/favicon-generator" }, null],
      [null, null],
      [{ href: "/heic-to-jpg" }, { href: "/heic-to-png" }],
      [{ href: "/heic-to-webp" }, { href: "/heic-to-pdf" }],
      [null, null],
      [{ href: "/png-to-webp" }, { href: "/jpg-to-webp" }],
      [{ href: "/webp-to-png" }, { href: "/webp-to-jpg" }],
      [{ href: "/jpg-to-png" }, { href: "/png-to-jpg" }],
      [{ href: "/jpg-to-pdf" }, { href: "/png-to-pdf" }],
      [null, null],
      [{ href: "/jpg-to-avif" }, { href: "/png-to-avif" }],
      [{ href: "/avif-to-jpg" }, { href: "/avif-to-png" }],
      [{ href: "/svg-to-png" }, { href: "/gif-to-png" }],
    ],
  },
  {
    id: "textCode",
    pairs: [
      [{ href: "/json-formatter" }, { href: "/html-formatter" }],
      [{ href: "/base64" }, { href: "/url-encoder" }],
      [{ href: "/word-counter" }, { href: "/lorem-ipsum" }],
    ],
  },
  {
    id: "tools",
    pairs: [
      [{ href: "/metadata-cleaner" }, { href: "/ai-text-scrubber" }],
      [{ href: "/checksum" }, null],
      [null, null],
      [{ href: "/password-generator" }, { href: "/qr-code-generator" }],
      [{ href: "/currency-converter" }, { href: "/unit-converter" }],
      [{ href: "/percentage-calc" }, { href: "/tip-calculator" }],
    ],
  },
];
